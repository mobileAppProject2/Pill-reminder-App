...
class _AddpillsState extends State<Addpills> {
  ...
  void AddPill(Function(String text) update, String name, String note, String startTime, String endTime, String remind, String repeat) async {
    try {
      ...
      final response = await http.post(
          ...
          body: convert.jsonEncode(<String, String>{
            'name': '$name', 'note': note, 'startTime':'$startTime', 'endTime':'$endTime', 'remind':'$remind', 'repeat':'$repeat', 'key': 'your_key'
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  AddPill(update, _controllerName.text, _controllerNote.text, _controllerStartTime.text, _controllerEndTime.text, _controllerRemind.text, _controllerRepeat.text);
